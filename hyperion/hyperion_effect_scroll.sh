...
# Check for 'down' argument passed by rotary encoder script. Amend $EFFECT to adjust for backwards rotation
# if needed.
if [ $# -eq 0 ]; then
...
if [ $EFFECT = 0 ]; then
  ...
  echo -e "======================\n"
  hyperion-remote --priority 50 --clearall
  ...
  echo -e "==========================================================\n"  
  hyperion-remote --priority 50 --effect "$EFFECT_NAME"
